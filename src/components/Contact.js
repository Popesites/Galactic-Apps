                    ...
                    <div className="row">
                        <div className="col-lg-4">
                            <div className="mt-4 pt-4">
                                <p className="mt-4"><span className="h5">Contact Information:</span><br /> <span className="text-muted d-block mt-2"><a href="mailto:hello@galacticapps.com">hello@galacticapps.com</a></span></p>
                                <p className="mt-4"><span className="h5">Business Hours:</span><br /> <span className="text-muted d-block mt-2">9:00AM To 6:00PM PST</span></p>
                            </div>
                        </div>
